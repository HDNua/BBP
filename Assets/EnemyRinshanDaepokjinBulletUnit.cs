...
/// 린샹 대폭진 얼음 탄환입니다.
/// </summary>
public class EnemyRinshanDaepokjinBulletUnit : EnemyBulletUnit
{
    #region 상수를 정의합니다.
    /// <summary>
    /// 대폭진 얼음이 플레이어에게 대미지를 입히는 시간입니다.
    /// </summary>
    public float TIME_DAEPOKJIN_DANGEROUS = 0.2f;
    ...
    protected override void Start()
    {
        ...
        // 
        SoundEffects[0].Play();
        Instantiate(_effects[0], transform.position, transform.rotation);
    ...
    protected override void Update()
    {
        ...
        // 
        if (_time >= TIME_DAEPOKJIN_DANGEROUS)
        {
            _damage = 0;
        }
